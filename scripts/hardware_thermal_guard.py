"""Deploy copy of daemons/hardware_thermal_guard.py.

Canonical operator path is daemons/hardware_thermal_guard.py. This copy is what
deploy_to_workstation.ps1 installs under D:\\MusicDatasets\\scripts.
Default action is log + throttle.json. ``--pause-daemon`` is opt-in only.
"""
