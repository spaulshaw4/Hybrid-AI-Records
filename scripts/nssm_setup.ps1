...
Write-Host "================================================================"
Write-Host "HYBRID 1.0 - NSSM SERVICE REGISTRATION"
Write-Host "================================================================"
...
nssm set $ServiceName Description "Hybrid 1.0 Automated Audio Generation Daemon Poller"
...
Write-Host "================================================================"
Write-Host "[SUCCESS] Background daemon is now running persistently as a Windows service."
Write-Host ""
